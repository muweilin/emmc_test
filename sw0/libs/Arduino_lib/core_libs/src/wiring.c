...
//Lei: 655us each timer A compare interval
// 16384 cycles in 25MHz 

// 32768 cycles in 50MHz 
//#define MICROSECONDS_PER_TIMERA_COMPARE (clockCyclesToMicroseconds(32768))

// 40960 cycles in 62.5MHz 
//#define MICROSECONDS_PER_TIMERA_COMPARE (clockCyclesToMicroseconds(40960))

//80MHz
#define MICROSECONDS_PER_TIMERA_COMPARE (clockCyclesToMicroseconds(52428))

//131072 cycles in 200MHz
//#define MICROSECONDS_PER_TIMERA_COMPARE (clockCyclesToMicroseconds(131072))
...
//	return ((m << 14) + t) * (1.0 / clockCyclesPerMicrosecond());  // 25Mhz
//	return ((m << 17) + t) * (1.0 / clockCyclesPerMicrosecond());  //Lei: 200Mhz
	return ((m << 15) + t) * (1.0 / clockCyclesPerMicrosecond());  // 50Mhz
//	return (m*40960 + t) * (1.0 / clockCyclesPerMicrosecond());  // 62.5Mhz
}

void delay(unsigned int ms) //in milisecond
{
...
void init()
{
	...
	//TOCRA = 0x20000;      // 200MHz 
	//TOCRA = 0x8000;       // 50MHz 
	TOCRA = 0xA000;         // 62.5MHz 
