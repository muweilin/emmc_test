...
/*
  ...
  if(old_function == 0)
 {
  switch( pinnumber )
  {
    case 0:  printf("spi_master_clk\n"); break;
    case 1:  printf("spi_master_csn0\n"); break;
    case 2:  printf("spi_master_sdo0\n"); break;
    case 3:  printf("spi_master_sdo1\n"); break;
    case 4:  printf("pwm0\n"); break;
    case 5:  printf("pwm1\n"); break;
    case 6:  printf("pwm2\n"); break;
    case 7:  printf("pwm3\n"); break;
...
int muxpin2gpiopin (int pinnumber) {
  ...
  switch( pinnumber )
  {
    ...
    case 4:  gpio_pin = 2; break;
    case 5:  gpio_pin = 3; break;
    case 6:  gpio_pin = 4; break;
    case 7:  gpio_pin = 5; break;
    default: 
