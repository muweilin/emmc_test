...
//    V1.0      V.Mancev       08 Feb 13      Initial version
...
//    V1.6      M.Stojanovic   08 Apr 15      Corrected SFDP JEDEC parameter
//    V1.7      M.Stojanovic   25 Apr 15      Corrected SFDP JEDEC parameters
//    V1.8      M.Stojanovic   13 May 15      Added DPD and RES_DPD commands
...
///////////////////////////////////////////////////////////////////////////////
    ...
    parameter mem_file_name     = "none";//"s25fs128s.mem";
    parameter otp_file_name     = "none";//"s25fs128sOTP.mem";

    parameter TimingModel       = "DefaultTimingModel";

    parameter  PartID           = "s25fs128s";
    ...
    parameter  SecNumHyb        = 264;
    parameter  BlockNumUni      = 63;
    parameter  BlockNumHyb      = 71;
    parameter  PageNum512       = 20'h7FFF;
    parameter  PageNum256       = 20'hFFFF;
...
//        `define SPEEDSIM;
    ...
    reg [BlockNumHyb:0] Block_Prot = 72'b0;
...
specify
    ...
    `ifdef SPEEDSIM
        ...
        specparam        tdevice_BE                = 180e9;//tBE = 180ms
    ...
    `else
        ...
        // Bulk Erase Operation
        specparam        tdevice_BE                = 180e12;//tBE = 180s
        // Evaluate Erase Status Time
...
//Bus cycle state
 ...
 reg [2:0] bus_cycle_state;
    ...
    begin: InitMemory
        ...
        begin
           // Memory Preload
           //s25fs128s.mem, memory preload file
    ...
    integer j;
        ...
        //assumptions:
        //1. TimingModel has format as S25FS128SXXXXXXXX_X_XXpF
        ...
        if (tmp_char1 == "0" || tmp_char1 == "1" || tmp_char1 == "2" ||
            tmp_char1 == "3")
        begin
            SECURE_OPN = 0;
        end
    ...
    integer k,l,m;
        ...
        SFDP_array[16'h1001] = 8'h20;
        SFDP_array[16'h1002] = 8'h18;
        SFDP_array[16'h1003] = 8'h4D;
        // Uniform 64kB sectors
        SFDP_array[16'h1004] = 8'h01;
        ...
        SFDP_array[16'h105D] = 8'h31;
        SFDP_array[16'h105E] = 8'h32;
        SFDP_array[16'h105F] = 8'h38;
                    ...
                    begin
                        ...
                        begin
                            ...
                            sect8_no_prot = ~Sec_Prot[8] && PPB_bits[8]
                                    && DYB_bits[8];
                            sect255_no_prot = ~Sec_Prot[255] && PPB_bits[255]
                                    && DYB_bits[255];
                            sect_no_prot = ~Sec_Prot[sect] && PPB_bits[sect]
                                    && DYB_bits[sect];
                            block8_no_prot = ~Block_Prot[8] && PPB_bits_b[8]
                                    && DYB_bits_b[8];
                            block63_no_prot = ~Block_Prot[63] && PPB_bits_b[63]
                                    && DYB_bits_b[63];
                            ...
                            begin
                                if ((UniformSec && sect_no_prot) ||
                                 ...
                                 (TopBoot && (sect <= 255) && sect_no_prot) ||
                                 (TopBoot && (sect > 255) && sect255_no_prot))
                                 begin
                                    if (~CR3_V[5])
                            ...
                            begin
                                if ((UniformSec && block_no_prot) ||
                                 ...
                                 (TopBoot && (block_e <= 63) && block_no_prot) ||
                                 (TopBoot && (block_e > 63) && block63_no_prot))
                                begin
                                    if (~CR3_V[5])
                                        next_state =  SECTOR_ERS;
                                    else
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        if (UniformSec || (TopBoot && SectorErased <= 255) ||
                        ...
                        begin
                            if (Sec_Prot[SectorErased] == 0 &&
                                PPB_bits[SectorErased] == 1 &&
                                DYB_bits[SectorErased] == 1)
    ...
    begin
        case (SR1_V[4:2])
            ...
            begin
                ...
                Block_Prot[BlockNumHyb:0] = {71{1'b0}};
            end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        Block_Prot[BlockNumUni:(BlockNumUni+1)*63/64]={1{1'b1}};
                        Block_Prot[(BlockNumUni+1)*63/64-1 : 0]    = {63{1'b0}};
                    end
                    else
                    begin
                        Sec_Prot[(SecNumUni+1)/64-1 : 0]       =   {4{1'b1}};
                        Sec_Prot[SecNumUni : (SecNumUni+1)/64] = {252{1'b0}};
                        Block_Prot[(BlockNumUni+1)/64-1 : 0]        = {1{1'b1}};
                        Block_Prot[BlockNumUni : (BlockNumUni+1)/64]={63{1'b0}};
                    end
                end
                ...
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*63/64] =
                                                                      {9{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*63/64-1 : 0]= {63{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/64-1 : 0]      =   {4{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/64] = {260{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/64-1 : 0]  =   {1{1'b1}};
                            Block_Prot[BlockNumHyb :(BlockNumHyb-7)/64] =
                                                                     {71{1'b0}};
                        end
                    end
                    ...
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*63/64+8] =
                                                                      {1{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*63/64+7 : 0]= {71{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/64+7 : 0]      =  {12{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/64+8]= {252{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/64+7 : 0]  =  {9{1'b1}};
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)/64+8]=
                                                                     {63{1'b0}};
                        end
                    end
                end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        Block_Prot[BlockNumUni : (BlockNumUni+1)*31/32] =
                                                                      {2{1'b1}};
                        Sec_Prot[(BlockNumUni+1)*31/32-1 : 0]      = {62{1'b0}};
                    end
                    else            // BP starts at Bottom
                    begin
                        Sec_Prot[(SecNumUni+1)/32-1 : 0]       = {8{1'b1}};
                        Sec_Prot[SecNumUni : (SecNumUni+1)/32] = {248{1'b0}};
                        Block_Prot[(BlockNumUni+1)/32-1 : 0]        = {2{1'b1}};
                        Block_Prot[BlockNumUni : (BlockNumUni+1)/32]={62{1'b0}};
                    end
                end
                else  // Hybrid Sector Architecture
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*31/32] =
                                                                     {10{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*31/32-1 : 0]= {62{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/32-1 : 0]      =   {8{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/32] = {256{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/32-1 : 0]  =   {2{1'b1}};
                            Block_Prot[BlockNumHyb :(BlockNumHyb-7)/32] =
                                                                     {70{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*31/32+8] =
                                                                      {2{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*31/32+7 : 0]= {70{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/32+7 : 0]      =  {16{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/32+8]= {248{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/32+7 : 0]  =  {10{1'b1}};
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)/32+8] =
                                                                     {62{1'b0}};
                        end
                    end
                end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        Block_Prot[BlockNumUni : (BlockNumUni+1)*15/16] =
                                                                      {4{1'b1}};
                        Block_Prot[(BlockNumUni+1)*15/16-1 : 0]    = {60{1'b0}};
                    end
                    else            // BP starts at Bottom
                    begin
                        Sec_Prot[(SecNumUni+1)/16-1 : 0]       = {16{1'b1}};
                        Sec_Prot[SecNumUni : (SecNumUni+1)/16] = {240{1'b0}};
                        Block_Prot[(BlockNumUni+1)/16-1 : 0]        = {4{1'b1}};
                        Block_Prot[BlockNumUni : (BlockNumUni+1)/16]={60{1'b0}};
                    end
                end
                else  // Hybrid Sector Architecture
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*15/16] =
                                                                     {12{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*15/16-1 : 0]= {60{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/16-1 : 0]      =  {16{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/16] = {248{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/16-1 : 0]  =  {4{1'b1}};
                            Block_Prot[BlockNumHyb :(BlockNumHyb-7)/16] =
                                                                     {68{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*15/16+8] =
                                                                      {4{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*15/16+7 : 0]= {68{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/16+7 : 0]      =  {24{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/16+8]= {248{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/16+7 : 0]  =  {12{1'b1}};
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)/16+8] =
                                                                     {60{1'b0}};
                        end
                    end
                end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        Block_Prot[BlockNumUni : (BlockNumUni+1)*7/8]={8{1'b1}};
                        Block_Prot[(BlockNumUni+1)*7/8-1 : 0]      = {56{1'b0}};
                    end
                    else            // BP starts at Bottom
                    begin
                        Sec_Prot[(SecNumUni+1)/8-1 : 0]       = {32{1'b1}};
                        Sec_Prot[SecNumUni : (SecNumUni+1)/8] = {224{1'b0}};
                        Block_Prot[(BlockNumUni+1)/8-1 : 0]         = {8{1'b1}};
                        Block_Prot[BlockNumUni : (BlockNumUni+1)/8]= {56{1'b0}};
                    end
                end
                else  // Hybrid Sector Architecture
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*7/8] =
                                                                     {16{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*7/8-1 : 0]  = {56{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/8-1 : 0]       =  {32{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/8]  = {232{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/8-1 : 0]   =   {8{1'b1}};
                            Block_Prot[BlockNumHyb :(BlockNumHyb-7)/8] =
                                                                     {64{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*7/8+8] =
                                                                      {8{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*7/8+7 : 0]  = {64{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/8+7 : 0]       =  {40{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/8+8] = {224{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/8+7 : 0]   =  {16{1'b1}};
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)/8+8] =
                                                                     {56{1'b0}};
                        end
                    end
                end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        Block_Prot[BlockNumUni : (BlockNumUni+1)*3/4] =
                                                                     {16{1'b1}};
                        Block_Prot[(BlockNumUni+1)*3/4-1 : 0]      = {48{1'b0}};
                    end
                    else            // BP starts at Bottom
                    begin
                        Sec_Prot[(SecNumUni+1)/4-1 : 0]       = {64{1'b1}};
                        Sec_Prot[SecNumUni : (SecNumUni+1)/4] = {192{1'b0}};
                        Block_Prot[(BlockNumUni+1)/4-1 : 0]        = {16{1'b1}};
                        Block_Prot[BlockNumUni : (BlockNumUni+1)/4]= {48{1'b0}};
                    end
                end
                else  // Hybrid Sector Architecture
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*3/4] =
                                                                     {24{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*3/4-1 : 0]  = {48{1'b0}};
                        ...
                        begin
                            ...
                            Block_Prot[(BlockNumHyb-7)/4-1 : 0]   =  {16{1'b1}};
                            Block_Prot[BlockNumHyb :(BlockNumHyb-7)/4] =
                                                                     {56{1'b0}};
                        end
                    end
                    else          // 4 KB Physical Sectors at Bottom
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)*3/4+8] =
                                                                     {16{1'b1}};
                            Block_Prot[(BlockNumHyb-7)*3/4+7 : 0]  = {56{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/4+7 : 0]       =  {72{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/4+8] = {192{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/4+7 : 0]   =  {24{1'b1}};
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)/4+8] =
                                                                     {48{1'b0}};
                        end
                    end
                end
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        Block_Prot[BlockNumUni : (BlockNumUni+1)/2]= {32{1'b1}};
                        Block_Prot[(BlockNumUni+1)/2-1 : 0]        = {32{1'b0}};
                    end
                    else            // BP starts at Bottom
                    begin
                        Sec_Prot[(SecNumUni+1)/2-1 : 0]       = {128{1'b1}};
                        Sec_Prot[SecNumUni : (SecNumUni+1)/2] = {128{1'b0}};
                        Block_Prot[(BlockNumUni+1)/2-1 : 0]        = {32{1'b1}};
                        Block_Prot[BlockNumUni : (BlockNumUni+1)/2]= {32{1'b0}};
                    end
                end
                else  // Hybrid Sector Architecture
                begin
                    ...
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)/2] =
                                                                     {40{1'b1}};
                            Block_Prot[(BlockNumHyb-7)/2-1 : 0]    = {32{1'b0}};
                        end
                        else
                        begin
                            Sec_Prot[(SecNumHyb-7)/2-1 : 0]      = {128{1'b1}};
                            Sec_Prot[SecNumHyb :(SecNumHyb-7)/2] = {136{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/2-1 : 0]    = {32{1'b1}};
                            Block_Prot[BlockNumHyb :(BlockNumHyb-7)/2] =
                                                                     {40{1'b0}};
                        end
                    end
                    ...
                    begin
                        ...
                        begin
                            ...
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)/2+8] =
                                                                     {32{1'b1}};
                            Block_Prot[(BlockNumHyb-7)/2+7 : 0]    = {40{1'b0}};
                        end
                        else            // BP starts at Bottom
                        begin
                            Sec_Prot[(SecNumHyb-7)/2+7 : 0]       = {136{1'b1}};
                            Sec_Prot[SecNumHyb:(SecNumHyb-7)/2+8] = {128{1'b0}};
                            Block_Prot[(BlockNumHyb-7)/2+7 : 0]    = {40{1'b1}};
                            Block_Prot[BlockNumHyb:(BlockNumHyb-7)/2+8] =
                                                                     {32{1'b0}};
                        end
                    end
            ...
            begin
                ...
                Block_Prot[BlockNumHyb:0] =   {72{1'b1}};
            end
        endcase
    end
                ...
                begin
                    ...
                    begin
                        block_e   = 64 +
                           (Addr-(AddrRANGE + 1 - 8*(SecSize4+1)))/(SecSize4+1);
                        AddrLOW  = AddrRANGE + 1 - 8*(SecSize4+1) +
                           (block_e-64)*(SecSize4+1);
                        AddrHIGH = AddrRANGE + 1 - 8*(SecSize4+1) +
                                   (block_e-64)*(SecSize4+1) + SecSize4;
                    end
                    else
                    begin
                        AddrLOW  = 63*(SecSize256+1);
                        AddrHIGH = AddrRANGE - 8*(SecSize4+1);
                    end
                end
                else
            ...
            begin
                ...
                begin
                    ...
                    if (Address < HybAddrLow)
                        ...
                        block_e = 64 + (Address - HybAddrLow) / (SecSize4+1);
                end
                else
                begin
                   block_e = conv;
