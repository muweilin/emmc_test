...
//  set_gpio_pin_value(PIN14, 1);
  start_timer();
}

void bench_timer_stop(void) {
  stop_timer();
//  set_gpio_pin_value(PIN14, 0);
}
...
{
//  Do not use GPIO as timer indicator due to gpio limits
//  set_pin_function(PIN14, FUNC_GPIO);
//  set_gpio_pin_direction(PIN14, DIR_OUT);
//  set_gpio_pin_value(PIN14, 0);
