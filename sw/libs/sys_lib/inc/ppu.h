...
#define PPU_BASE_ADDR             0x10000000
...
#define CAMCTL_FRAME1_ADDR        ( CAMCTL_BASE_ADDR + 0x00)
#define CAMCTL_FRAME2_ADDR        ( CAMCTL_BASE_ADDR + 0x04)
#define CAMCTL_FRAME3_ADDR        ( CAMCTL_BASE_ADDR + 0x08)

#define CAMCTL_STATUS             ( CAMCTL_BASE_ADDR + 0x14)
...
#define SPI0_BASE_ADDR                 ( SOC_PERIPHERALS_BASE_ADDR + 0x2000 )
#define TIMER_BASE_ADDR               ( SOC_PERIPHERALS_BASE_ADDR + 0x3000 )
#define EVENT_UNIT_BASE_ADDR          ( SOC_PERIPHERALS_BASE_ADDR + 0x4000 )
#define I2C0_BASE_ADDR                 ( SOC_PERIPHERALS_BASE_ADDR + 0x5000 )
#define SOC_CTRL_BASE_ADDR            ( SOC_PERIPHERALS_BASE_ADDR + 0x6000 )

#define UART1_BASE_ADDR               ( SOC_PERIPHERALS_BASE_ADDR + 0x7000 )
#define SPI1_BASE_ADDR                ( SOC_PERIPHERALS_BASE_ADDR + 0x8000 )
#define I2C1_BASE_ADDR                ( SOC_PERIPHERALS_BASE_ADDR + 0x9000 )
#define PWM_BASE_ADDR                 0x1A118000
