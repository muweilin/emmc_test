...
set_property -dict [list CONFIG.USE_DYN_RECONFIG {false} CONFIG.PRIM_IN_FREQ {200.000} CONFIG.CLKOUT2_USED {true} CONFIG.CLKOUT3_USED {true} CONFIG.PRIMARY_PORT {clk100_i} CONFIG.CLK_OUT1_PORT {clk200_o} CONFIG.CLK_OUT2_PORT {clk100_o} CONFIG.CLK_OUT3_PORT {clk50_o} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {200.000} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {100.000} CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {50.000} CONFIG.LOCKED_PORT {locked} CONFIG.RESET_TYPE {ACTIVE_LOW} CONFIG.RESET_PORT {rstn_i}] [get_ips $ip_name]
