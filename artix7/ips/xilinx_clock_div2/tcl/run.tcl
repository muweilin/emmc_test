...
set_property -dict [list CONFIG.USE_DYN_RECONFIG {false} CONFIG.PRIM_IN_FREQ {50.000}  CONFIG.PRIMARY_PORT {clk50_i} CONFIG.CLK_OUT1_PORT {clk5_o}  CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {5.000}  CONFIG.LOCKED_PORT {locked} CONFIG.RESET_TYPE {ACTIVE_LOW} CONFIG.RESET_PORT {rstn_i}] [get_ips $ip_name]
