...
set ip_name xilinx_mem_512x32_dp

create_project $ip_name . -part $partNumber

create_ip -name blk_mem_gen -vendor xilinx.com -library ip -module_name $ip_name

set_property -dict [list CONFIG.Memory_Type {True_Dual_Port_RAM} CONFIG.Write_Width_A {32} CONFIG.Write_Depth_A {512} CONFIG.Register_PortA_Output_of_Memory_Primitives {false} CONFIG.Collision_Warnings {NONE} CONFIG.Register_PortB_Output_of_Memory_Primitives {false} CONFIG.Read_Width_A {32} CONFIG.Write_Width_B {32} CONFIG.Read_Width_B {32} CONFIG.Enable_B {Use_ENB_Pin} CONFIG.Port_B_Clock {100} CONFIG.Port_B_Write_Rate {50} CONFIG.Port_B_Enable_Rate {100}] [get_ips ${ip_name}]
