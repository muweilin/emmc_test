...
set_property PACKAGE_PIN F21 [get_ports {jtag_trstn}]
set_property IOSTANDARD LVCMOS33 [get_ports {jtag_trstn}]

set_property PACKAGE_PIN H19 [get_ports {jtag_tms}]
...
set_property PACKAGE_PIN G20 [get_ports {jtag_tdo}]
set_property IOSTANDARD LVCMOS33 [get_ports {jtag_tdo}]
######################
##    emmc leavings ##
######################
set_property PACKAGE_PIN AB10 [get_ports {emmc_cdata[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[4]}]

set_property PACKAGE_PIN AA9 [get_ports {emmc_cdata[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[5]}]

set_property PACKAGE_PIN AA11 [get_ports {emmc_cdata[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[6]}]

set_property PACKAGE_PIN AA10 [get_ports {emmc_cdata[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[7]}]

set_property PACKAGE_PIN Y12 [get_ports {emmc_cdata[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[12]}]

set_property PACKAGE_PIN Y11 [get_ports {emmc_cdata[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[13]}]

set_property PACKAGE_PIN AA14 [get_ports {emmc_cdata[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[14]}]

set_property PACKAGE_PIN Y13 [get_ports {emmc_cdata[15]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[15]}]


######################
##    TF Card       ##
######################
set_property PACKAGE_PIN N22 [get_ports {emmc_cdata[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[0]}]

set_property PACKAGE_PIN M22 [get_ports {emmc_cdata[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[1]}]

set_property PACKAGE_PIN N20 [get_ports {emmc_cdata[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[2]}]

set_property PACKAGE_PIN M20 [get_ports {emmc_cdata[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[3]}]

set_property PACKAGE_PIN L21 [get_ports {emmc_cclk_out[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cclk_out[0]}]

set_property PACKAGE_PIN M21 [get_ports {emmc_ccmd[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_ccmd[0]}]
######################
##    WIFI          ##
######################
set_property PACKAGE_PIN V15 [get_ports {emmc_cdata[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[8]}]

set_property PACKAGE_PIN U15 [get_ports {emmc_cdata[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[9]}]

set_property PACKAGE_PIN V19 [get_ports {emmc_cdata[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[10]}]

set_property PACKAGE_PIN V18 [get_ports {emmc_cdata[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cdata[11]}]

set_property PACKAGE_PIN P16 [get_ports {emmc_cclk_out[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_cclk_out[1]}]

set_property PACKAGE_PIN R17 [get_ports {emmc_ccmd[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {emmc_ccmd[1]}]

######################
##    GPIO          ##
######################
#KEY
set_property PACKAGE_PIN A13 [get_ports {gpio[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[0]}]
#LED0
set_property PACKAGE_PIN A14 [get_ports {gpio[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[1]}]

set_property PACKAGE_PIN C13 [get_ports {gpio[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[2]}]

set_property PACKAGE_PIN B13 [get_ports {gpio[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[3]}]

set_property PACKAGE_PIN A15 [get_ports {gpio[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[4]}]

set_property PACKAGE_PIN A16 [get_ports {gpio[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[5]}]

set_property PACKAGE_PIN E13 [get_ports {gpio[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[6]}]

set_property PACKAGE_PIN E14 [get_ports {gpio[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[7]}]

set_property PACKAGE_PIN A18 [get_ports {gpio[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[8]}]

set_property PACKAGE_PIN A19 [get_ports {gpio[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio[9]}]

set_property PACKAGE_PIN C14 [get_ports {gpio[10]}]
...
##########
#U_T J6-19
set_property PACKAGE_PIN B17 [get_ports uart_tx]
set_property IOSTANDARD LVCMOS33 [get_ports uart_tx]

#U_R J6-21
set_property PACKAGE_PIN C22 [get_ports uart_rx]
...
##########
#J13.4: B14_L18_N
set_property PACKAGE_PIN U18 [get_ports uart1_tx]
set_property IOSTANDARD LVCMOS33 [get_ports uart1_tx]

#J13.5: B14_L18_P
set_property PACKAGE_PIN U17 [get_ports uart1_rx]
set_property IOSTANDARD LVCMOS33 [get_ports uart1_rx]

#J13.7: B13_L16_p
set_property PACKAGE_PIN W15 [get_ports uart1_cts]
set_property IOSTANDARD LVCMOS33 [get_ports uart1_cts]

#J13.6: B13_L16_N
set_property PACKAGE_PIN W16 [get_ports uart1_rts]
set_property IOSTANDARD LVCMOS33 [get_ports uart1_rts]
...
############################
#S_CK J6-29
set_property PACKAGE_PIN G21 [get_ports spi_master_clk_o]
set_property IOSTANDARD LVCMOS33 [get_ports spi_master_clk_o]
#CS J6-27
set_property PACKAGE_PIN E19 [get_ports spi_master_csn0_o]
set_property IOSTANDARD LVCMOS33 [get_ports spi_master_csn0_o]
#S_R J6-25
set_property PACKAGE_PIN E22 [get_ports spi_master_sdo0_o]
set_property IOSTANDARD LVCMOS33 [get_ports spi_master_sdo0_o]
#S_T J6-23
set_property PACKAGE_PIN C18 [get_ports spi_master_sdi0_i]
...
########################
#CLK 
set_property PACKAGE_PIN U21 [get_ports spi1_master_clk_o]
#CS
set_property PACKAGE_PIN C17 [get_ports spi1_master_csn0_o]
#MISO
set_property PACKAGE_PIN P19 [get_ports spi1_master_sdi0_i]
#MOSI
set_property PACKAGE_PIN T21 [get_ports spi1_master_sdo0_o]
...
#J5-16
set_property PACKAGE_PIN D21 [get_ports pwm[1]]
#J5-17
set_property PACKAGE_PIN G15 [get_ports pwm[2]]
#J5-18
set_property PACKAGE_PIN G16 [get_ports pwm[3]]
...
#J5-11
set_property PACKAGE_PIN D17 [get_ports spi_sck]
#J5-12
set_property PACKAGE_PIN E18 [get_ports spi_csn]
#J5-13
set_property PACKAGE_PIN F19 [get_ports spi_sdo0]
#J5-14
set_property PACKAGE_PIN F20 [get_ports spi_sdi0]
...
##ly 1.5
set_false_path -from top_i/ppu_top_i/peripherals_i/ahb_subsystem_i/DWC_mobile_storage_top/DWC_mobile_storage/U_DWC_mobile_storage_b2c/b2c_stage1_creset_n_reg/C -to top_i/ppu_top_i/peripherals_i/ahb_subsystem_i/DWC_mobile_storage_top/DWC_mobile_storage/U_DWC_mobile_storage_ciu/toggle_gen[0].toggle1_reg[0]/CLR
set_false_path -from top_i/ppu_top_i/peripherals_i/ahb_subsystem_i/DWC_mobile_storage_top/DWC_mobile_storage/U_DWC_mobile_storage_b2c/b2c_stage1_creset_n_reg/C -to top_i/ppu_top_i/peripherals_i/ahb_subsystem_i/DWC_mobile_storage_top/DWC_mobile_storage/U_DWC_mobile_storage_ciu/toggle_gen[1].toggle1_reg[1]/CLR