...
set ip_name xilinx_mem_16384x32

create_project $ip_name . -part $partNumber

create_ip -name blk_mem_gen -vendor xilinx.com -library ip -module_name $ip_name

set_property -dict [list CONFIG.Memory_Type {Single_Port_RAM} CONFIG.Use_Byte_Write_Enable {true} CONFIG.Byte_Size {8} CONFIG.Write_Width_A {32} CONFIG.Write_Depth_A {16384} CONFIG.Register_PortA_Output_of_Memory_Primitives {false} CONFIG.Use_RSTA_Pin {true}] [get_ips ${ip_name}]
